...
# ⚠️ title MUST be a real human-readable title (e.g. "How to Build a CRM with AI")
# NEVER set title to the slug (e.g. "how-to-build-a-crm-with-ai") — this shows as
# the slug everywhere: page header, prev/next nav, OG image, search results.
...
**Format — always open in new tab:**
```mdx
[250,000+ GitHub stars](https://github.com/openclaw/openclaw){target="_blank" rel="noopener noreferrer"}
```
...
- [ ] 2–4 external links — each tied to a specific cited statistic; only approved-tier sources; opens in new tab
